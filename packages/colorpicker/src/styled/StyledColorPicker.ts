...
export interface IStyledColorPickerProps extends ThemeProps<DefaultTheme> {
  isCompact?: boolean;
}

const colorStyles = (props: IStyledColorPickerProps) => {
...
const sizeStyles = (props: IStyledColorPickerProps) => {
...
export const StyledColorPicker = styled.div.attrs<IStyledColorPickerProps>({
